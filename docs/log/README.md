...
- [2026-09-14](2026-09-14-rgb-video-step1.md) — RGB-only ingest step 1: MASt3R depth/conf/poses/intrinsics export (anchor-only bundle), guarded metric scale, `VideoReader` (mp4 → frames bundle); no API/worker changes
