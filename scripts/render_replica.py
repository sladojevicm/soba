...
Usage:
  ...
  PYTHONPATH=src python scripts/render_replica.py match-test \
      --scene-dir ~/projects/vid2sim/data/replica/scenes/office_4 \
      --bundle ~/projects/vid2sim/data/replica/bundles/office_4 \
      --frame 0 --out ~/projects/vid2sim/data/replica/previews/frame_match_office_4.png

  # full custom-trajectory bundle:
  PYTHONPATH=src python scripts/render_replica.py render \
      --scene-dir ~/projects/vid2sim/data/replica/scenes/office_4 \
      --out ~/projects/vid2sim/data/replica/bundles/office_4_v2 --frames 1800
"""
